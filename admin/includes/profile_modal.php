        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST"
                    ...
                    <div class="form-group">
                        <label for="firstname" class="col-sm-3 control-label">Admin Firstname</label>
                    ...
                    <div class="form-group">
                        <label for="lastname" class="col-sm-3 control-label">Admin Lastname</label>
                    ...
                    <div class="form-group">
                        <label for="photo" class="col-sm-3 control-label">Admin Photo:</label>
                    ...
                    <hr>
                    <div class="form-group">
                        <label for="curr_password" class="col-sm-3 control-label"> Admin Current Password:</label>
